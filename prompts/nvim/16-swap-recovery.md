# nvim-wiki task: 16-swap-recovery

hey — your task is **wiki/tasks/16-swap-recovery.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/16-swap-recovery.md` — your specific task brief: "# Swap recovery parser"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/16-swap-recovery.md` before anything else.
...
1. write your findings to `wiki/findings/16-swap-recovery/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/16-swap-recovery/
   git commit -m "findings(16-swap-recovery): <one-line summary>"
