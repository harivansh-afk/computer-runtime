# nvim-wiki task: 08-trust-db

hey — your task is **wiki/tasks/08-trust-db.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/08-trust-db.md` — your specific task brief: "# Trust database and :trust bridge"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/08-trust-db.md` before anything else.
...
1. write your findings to `wiki/findings/08-trust-db/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/08-trust-db/
   git commit -m "findings(08-trust-db): <one-line summary>"
