# nvim-wiki task: 09-tagfile-discovery

hey — your task is **wiki/tasks/09-tagfile-discovery.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/09-tagfile-discovery.md` — your specific task brief: "# Tag and helpfile discovery"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/09-tagfile-discovery.md` before anything else.
...
1. write your findings to `wiki/findings/09-tagfile-discovery/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/09-tagfile-discovery/
   git commit -m "findings(09-tagfile-discovery): <one-line summary>"
