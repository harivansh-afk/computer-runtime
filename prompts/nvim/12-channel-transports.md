# nvim-wiki task: 12-channel-transports

hey — your task is **wiki/tasks/12-channel-transports.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/12-channel-transports.md` — your specific task brief: "# Channel transport creation"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/12-channel-transports.md` before anything else.
...
1. write your findings to `wiki/findings/12-channel-transports/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/12-channel-transports/
   git commit -m "findings(12-channel-transports): <one-line summary>"
