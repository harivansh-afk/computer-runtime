# nvim-wiki task: 15-tui-csi-input

hey — your task is **wiki/tasks/15-tui-csi-input.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/15-tui-csi-input.md` — your specific task brief: "# TUI CSI and raw input parsing"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/15-tui-csi-input.md` before anything else.
...
1. write your findings to `wiki/findings/15-tui-csi-input/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/15-tui-csi-input/
   git commit -m "findings(15-tui-csi-input): <one-line summary>"
