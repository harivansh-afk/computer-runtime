# nvim-wiki task: 18-spell-affix-parser

hey — your task is **wiki/tasks/18-spell-affix-parser.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/18-spell-affix-parser.md` — your specific task brief: "# Spell affix parser"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/18-spell-affix-parser.md` before anything else.
...
1. write your findings to `wiki/findings/18-spell-affix-parser/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/18-spell-affix-parser/
   git commit -m "findings(18-spell-affix-parser): <one-line summary>"
