# nvim-wiki task: 13-termrequest

hey — your task is **wiki/tasks/13-termrequest.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/13-termrequest.md` — your specific task brief: "# Terminal TermRequest bridge"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/13-termrequest.md` before anything else.
...
1. write your findings to `wiki/findings/13-termrequest/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/13-termrequest/
   git commit -m "findings(13-termrequest): <one-line summary>"
