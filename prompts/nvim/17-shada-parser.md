# nvim-wiki task: 17-shada-parser

hey — your task is **wiki/tasks/17-shada-parser.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/17-shada-parser.md` — your specific task brief: "# ShaDa item parser"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/17-shada-parser.md` before anything else.
...
1. write your findings to `wiki/findings/17-shada-parser/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/17-shada-parser/
   git commit -m "findings(17-shada-parser): <one-line summary>"
