# nvim-wiki task: 14-osc52-selection

hey — your task is **wiki/tasks/14-osc52-selection.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/14-osc52-selection.md` — your specific task brief: "# OSC 52 selection parser"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/14-osc52-selection.md` before anything else.
...
1. write your findings to `wiki/findings/14-osc52-selection/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/14-osc52-selection/
   git commit -m "findings(14-osc52-selection): <one-line summary>"
