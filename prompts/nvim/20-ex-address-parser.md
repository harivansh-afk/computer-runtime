# nvim-wiki task: 20-ex-address-parser

hey — your task is **wiki/tasks/20-ex-address-parser.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/20-ex-address-parser.md` — your specific task brief: "# Ex address parser"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/20-ex-address-parser.md` before anything else.
...
1. write your findings to `wiki/findings/20-ex-address-parser/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/20-ex-address-parser/
   git commit -m "findings(20-ex-address-parser): <one-line summary>"
