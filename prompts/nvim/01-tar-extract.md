# nvim-wiki task: 01-tar-extract

hey — your task is **wiki/tasks/01-tar-extract.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/01-tar-extract.md` — your specific task brief: "# Tar plugin extraction path"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/01-tar-extract.md` before anything else.
...
1. write your findings to `wiki/findings/01-tar-extract/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/01-tar-extract/
   git commit -m "findings(01-tar-extract): <one-line summary>"
