# nvim-wiki task: 04-tag-jump-expand

hey — your task is **wiki/tasks/04-tag-jump-expand.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/04-tag-jump-expand.md` — your specific task brief: "# Tag jump and tag filename expansion"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/04-tag-jump-expand.md` before anything else.
...
1. write your findings to `wiki/findings/04-tag-jump-expand/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/04-tag-jump-expand/
   git commit -m "findings(04-tag-jump-expand): <one-line summary>"
