# nvim-wiki task: 11-rpc-dispatch

hey — your task is **wiki/tasks/11-rpc-dispatch.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/11-rpc-dispatch.md` — your specific task brief: "# MessagePack-RPC dispatch"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/11-rpc-dispatch.md` before anything else.
...
1. write your findings to `wiki/findings/11-rpc-dispatch/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/11-rpc-dispatch/
   git commit -m "findings(11-rpc-dispatch): <one-line summary>"
