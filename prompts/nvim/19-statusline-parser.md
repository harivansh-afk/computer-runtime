# nvim-wiki task: 19-statusline-parser

hey — your task is **wiki/tasks/19-statusline-parser.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/19-statusline-parser.md` — your specific task brief: "# Statusline mini-language parser"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/19-statusline-parser.md` before anything else.
...
1. write your findings to `wiki/findings/19-statusline-parser/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/19-statusline-parser/
   git commit -m "findings(19-statusline-parser): <one-line summary>"
