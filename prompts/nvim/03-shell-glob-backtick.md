# nvim-wiki task: 03-shell-glob-backtick

hey — your task is **wiki/tasks/03-shell-glob-backtick.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/03-shell-glob-backtick.md` — your specific task brief: "# Shell wildcard and backtick expansion"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/03-shell-glob-backtick.md` before anything else.
...
1. write your findings to `wiki/findings/03-shell-glob-backtick/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/03-shell-glob-backtick/
   git commit -m "findings(03-shell-glob-backtick): <one-line summary>"
