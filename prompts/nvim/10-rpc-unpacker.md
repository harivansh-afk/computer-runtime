# nvim-wiki task: 10-rpc-unpacker

hey — your task is **wiki/tasks/10-rpc-unpacker.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/10-rpc-unpacker.md` — your specific task brief: "# MessagePack-RPC unpacker"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/10-rpc-unpacker.md` before anything else.
...
1. write your findings to `wiki/findings/10-rpc-unpacker/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/10-rpc-unpacker/
   git commit -m "findings(10-rpc-unpacker): <one-line summary>"
