# nvim-wiki task: 06-mapset-secure

hey — your task is **wiki/tasks/06-mapset-secure.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/06-mapset-secure.md` — your specific task brief: "# mapset secure-mode gate"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/06-mapset-secure.md` before anything else.
...
1. write your findings to `wiki/findings/06-mapset-secure/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/06-mapset-secure/
   git commit -m "findings(06-mapset-secure): <one-line summary>"
