# nvim-wiki task: 05-modelines

hey — your task is **wiki/tasks/05-modelines.md** in the nvim-wiki repo.
...
- **/home/node/workspace/nvim-wiki** — the wiki (has all the context you need)
  ...
  - `wiki/tasks/05-modelines.md` — your specific task brief: "# Modeline execution pipeline"
...
1. read `/home/node/workspace/nvim-wiki/wiki/runtime.md` and `/home/node/workspace/nvim-wiki/wiki/tasks/05-modelines.md` before anything else.
...
1. write your findings to `wiki/findings/05-modelines/findings.md` — include:
...
2. stage, commit, push to `main`. use this exact recipe so 20 agents pushing at once don't deadlock each other:
   ...
   git add wiki/findings/05-modelines/
   git commit -m "findings(05-modelines): <one-line summary>"
